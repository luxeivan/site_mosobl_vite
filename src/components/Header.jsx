                    ...
                    <div className="container">
                      <div className="first-screen__block">
                        ...
                        <Flex justify="center" gap={20} wrap={"wrap"}>
                          <div
                            className={`${styles.creditRating} ${styles.creditRatingLeft}`}
                          >
                            <div className="creditRating__desc">
                              ...
                              <p className="creditRating__text">
                                ...
                                подтверждения наличия/отсутствия инженерных
                                сетей на территории земельного участка в
                                электронном виде Вы можете посредством сервиса
                                «ВсеСети» на Портале государственных и
                                муниципальных услуг Московской области.
                                Консультации по поступившим заявкам в АО
                                «Мособлэнерго» посредством сервиса «ВсеСети» и
                                результатам рассмотрения заявок можно получить
                                по тел. 8 (495)780-39-62 доб. 10-96.
                              </p>
                            ...
                            <div className="creditRating__desc">
                              <p className="creditRating__text">
                                Требования к организациям по защите объектов
                                электросетевого хозяйства АО «Мособлэнерго» от
                                механических повреждений при
                                пересечении/параллельном следовании со
                                строящимися объектами Заинтересованных лиц
                              </p>
                              <div className="creditRating__link-area">
                                <a
                          ...
                          <Flex
                            ...
                            gap={20}
                            className={styles.creditRatingLeft}
                          >
                            <div className={styles.creditRating}>
                              ...
                              <div className="creditRating__desc">
                                ...
                                <p className="creditRating__text">
                                  ...
                                  отключениях). Получить информацию об
                                  отключениях можно, перейдя по кнопке в верхнем
                                  правом углу сайта «Узнать об отключениях» или
                                  по кнопке ниже.
                                </p>
                                <div className="creditRating__link-area">
                                  <Link
                            ...
                            <div className={styles.creditRating}>
                              ...
                              <div className="creditRating__desc">
                                ...
                                <p className="creditRating__text">
                                  Работники АО «Мособлэнерго» и наши
                                  представители НИКОГДА не запрашивают
                                  персональные данные (номер паспорта, СНИЛС и
                                  т.д.) по телефону.
                                </p>
                                <p className="creditRating__text">
