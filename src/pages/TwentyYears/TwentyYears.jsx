    ...
    >
      ...
      <div className={`text-area`}>
        ...
        <section className={`${styles.bookIntro}`}>
          ...
          {/* Чисто проверить работает ли коммит */}
        ...
        <section className={styles.bookIntro}>
          ...
          <p className="bigParagraph text-area border-bottom">
            В процессе работы над исследованием мы обнаружили уникальные
            архивные документы первых электросетевых предприятий городов
            Подмосковья, в том числе и довоенной эпохи – приказы, письма,
            распоряжения, десятки фотографий и свидетельств, воспоминаний и
            исторических фактов, свершившихся в различные периоды становления и
            развития отрасли. К сожалению, вместить в одну книгу подробную
            историю каждой электросети, которая теперь стала частью
            «Мособлэнерго», физически невозможно, поэтому мы постарались выбрать
            и включить в книгу основные события. Для всех, кто хотел бы более
            подробно погрузиться в историю электросетей Подмосковья мы
            разместили здесь всю найденную информацию.
          </p>
        </section>
        {/* Галереи по филиалам */}
        {photos.map((filial) => (
