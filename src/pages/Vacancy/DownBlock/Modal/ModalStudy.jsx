...
export default function ModalStudy({ visible, onCancel }) {
      ...
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        ...
        <Form.Item
          ...
          rules={[
            ...
            { type: "date", message: "Введите вашу Дату Рождения" },
          ]}
        >
        ...
        <Form.Item
          name="universitydate"
          label={labelWithStar("Год поступления")}
          rules={[{ required: true, message: "Введите год поступления" }]}
        >
